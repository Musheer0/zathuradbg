...
const FAQSection = () => (
 ...
 <InfiniteSlider className="w-full h-full flex items-center   " speedOnHover={10} >
     {FAQs.map((faq, index) => (
       <Button key={index}  duration={(index+3)*1000} 
        className="h-full  shrink-0 "  containerClassName="shrink-0"    as={'div'}>
         <div 
