...
const Features = () => {
  ...
  <div id='features' className='flex items-center flex-col gap-10 pt-20 w-full pb-10  h-full'>
    <p className='text-2xl text-center max-w-2xl'>An all-in-one lightweight debugger for learning, editing, and matering assembly — beginner-friendly, no setup required</p>
    <div className=" bento gap-10 flex-1 w-[90%] flex flex-col  max-w-[1100px]">
      <div className="l1 flex lg:flex-row flex-col items-stretch justify-items-stretch flex-wrap  gap-2 flex-1">
      <Button duration={4000} as={'div'}
      className=" No Setup Needed px-5 py-10  rounded-xl border-zinc-800 border"
      >
      ...
      <div className="hex-editor min-h-[400px] h-full flex-1 items-end flex justify-start rounded-xl overflow-hidden bg-gradient-to-t from-indigo-700/70 to-transparent p-2  relative ">
       ...
       <p className='drop-shadow-lg font-semibold'>
        ...
        Edit memory live as code runs, enabling real-time updates to variables and memory, 
        improving debugging and allowing for immediate feedback during development.</p>
       </div>
      </div>
      </div>
      <div className="l3  w-fit group md:hover:to-transparent hover:h-[470px] md:hover:h-[690px] h-[420px]  transition-all duration-200 p-2 relative  bg-gradient-to-b from-transparent to-indigo-700 rounded-xl overflow-hidden">
        ...
        ZathuraDbg introduces full time travel debugging, 
        allowing developers to step backward through execution while preserving
         memory and stack integrity. All with just a few megabytes of overhead.
        </p>
        </div>
      ...
      <div className="l2 flex lg:flex-row flex-col-reverse  gap-2 flex-wrap flex-1">
